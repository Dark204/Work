...
for m=1:6 
 for n=1:7
    ...
    outputmatrix1(1,:,m,n)=mean(Gmean_temp,1); 
    outputmatrix1(2,:,m,n)=std(Gmean_temp,1);  
    outputmatrix1(3,:,m,n)=mean(Auc_temp,1);   
    outputmatrix1(4,:,m,n)=std(Auc_temp,1);    
    outputmatrix1(5,:,m,n)=mean(Balance_temp,1); 
    outputmatrix1(6,:,m,n)=std(Balance_temp,1);  
    clear Gmean_temp;
    clear Auc_temp;
    clear Balance_temp;
 end
